...
class UnscrambleList extends ConsumerStatefulWidget {
  const UnscrambleList({super.key});

  @override
  ConsumerState<UnscrambleList> createState() => _UnscrambleListState();
}

class _UnscrambleListState extends ConsumerState<UnscrambleList> {
  @override
            ...
            data: (packages) => Padding(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () => context.push(
                      '/unscramble/${packages[index].packageId}',
                    ),
                    child: Card(
                      elevation: 3,
